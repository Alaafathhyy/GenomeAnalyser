...
$result= $conn->query($sql);
if ($result->num_rows > 0) {
   echo "<h3> User Names that registerd : </h3>";
   echo "<table>
    <tr>
    <th>User Name  </th>
    </tr> ";
...
function GroupByUser($conn)
{
   ...
   if ($result->num_rows > 0) {
      echo "<h3> User Names and number of Genomes that have been sumbitted by: </h3>";
...
function GroupByOrgan($conn)
{
   ...
   if ($result->num_rows > 0) {
      echo "<h3> Organ Names and number of genes of each organ: </h3>";
      echo "<table>
      <tr>
      <th>Organ Name </th>
      <th>Number of Genes </th>
...
{
   echo '<table id="t1" style="width: 100%">
